      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-zinc-400 mb-8">
            I am currently seeking software development, QA, cloud, and related internship opportunities.
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:jobs.zainiqbal@gmail.com"
                    className="text-zinc-400 hover:text-white transition-colors"
                  >
                    jobs.zainiqbal@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">Ontario</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-zinc-300 font-medium">GitHub Profile</p>
                  <p className="text-zinc-400 text-sm">View my code repositories</p>
                </div>
              </a>

              <a
                href="https://www.linkedin.com/in/iqzain"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 bg-zinc-800 rounded-lg hover:bg-zinc-700 transition-colors"
              >
                ...
                <div>
                  <p className="text-zinc-300 font-medium">LinkedIn Profile</p>
                  <p className="text-zinc-400 text-sm">Connect professionally</p>
                </div>
              </a>
